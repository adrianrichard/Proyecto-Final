...
class Paciente():
    ...
    def crear_w(self):
        ...
        Button(self.frame_principal, text= 'cargar',  font= ('Comic Sans MS', 12, BOLD), fg= 'white', bg= '#1F704B', activebackground= 'gray', bd= 0, command= self.conexionBBDD).grid(column= 3, row=2, pady= 5, padx= 200)
