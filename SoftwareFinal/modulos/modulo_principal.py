...
class MasterPanel:
    ...
    def widgets(self):
        self.imagen_usuario = utl.leer_imagen('imagenes/usuario_icono.png', (38, 38), True)
        self.imagen_paciente = utl.leer_imagen('imagenes/paciente.png', (38, 38), True)
        self.imagen_ayuda = utl.leer_imagen('imagenes/ayuda.png', (20, 20), True)
        self.imagen_calendario = utl.leer_imagen('imagenes/calendario.png', (38, 38), True)
        self.imagen_historia_clinica = utl.leer_imagen('imagenes/odontograma.png', (38, 38), True)
        self.imagen_galeria = utl.leer_imagen('imagenes/galeria.png', (38, 38), True)
        self.imagen_herramientas = utl.leer_imagen('imagenes/statistics-removebg.png', (38, 38), True)
        self.imagen_agregar = utl.leer_imagen('imagenes/agregar.png', (30, 30), True)
        self.imagen_editar = utl.leer_imagen('imagenes/editar.png', (38, 38), True)
