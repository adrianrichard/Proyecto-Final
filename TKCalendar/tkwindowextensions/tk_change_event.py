...
class TKChangeEvent:
    ...
    def _make_header(self):
        Label(self.main_frame, text="MODIFICAR CITA", font="Courier 12 underline", bg="#BDC1BE").pack(pady=15)
    ...
    def _change_event(self):
        ...
        if ev_dict["time_hours"] == "Hour" or ev_dict["time_minutes"] == "Minutes" or ev_dict["title"] == "Title":
            ...
            self.warning = Label(self.main_frame, text="Please fill in required information.", bg="#BDC1BE", fg="red", font="Helvetica 13")
        ...
        if EventController.update_event(event, self.id):
            self.root.confirmation = Label(self.root, text="¡Cita modificada!", font="Courier 10")
        else:
